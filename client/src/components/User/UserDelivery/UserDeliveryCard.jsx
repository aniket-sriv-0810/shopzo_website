...
import CancelDelivery from "../../../pages/User/UserCancelDelivery";
import UserDeleteCancelledDelivery from "../../../pages/User/UserDeleteCancelDelivery";

const DeliveryCard = ({ delivery, userId, onCancelSuccess }) => {
  ...
  return (
    <div className="bg-white rounded-3xl shadow-lg border border-gray-200 p-5 sm:p-7 transition hover:shadow-2xl hover:scale-[1.01] flex flex-col">
      ...
      <div className="mt-auto flex flex-col sm:flex-row gap-4 justify-between items-center">
        ...
        <button
          onClick={() => navigate(`/delivery/${_id}/confirmation`)}
