...
const CategoryCard = ({ category }) => {
  ...
  return (
    <div className="relative group bg-white dark:bg-zinc-900 rounded-2xl overflow-hidden shadow-md hover:shadow-2xl transition-shadow duration-300 w-full h-[350px]">
