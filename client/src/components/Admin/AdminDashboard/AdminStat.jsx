...
const AdminStat = ({ adminData }) => {
  const stats = [
    { id: "users-btn", count: adminData.totalUsers, label: "Users Registered", icon: <FaUsers className="text-cyan-600 text-4xl" />, link: "/admin/users" },
    { id: "vendors-btn", count: adminData.totalVendors, label: "Vendors Listed", icon: <FaStore className="text-green-500 text-4xl" />, link: "/admin/vendors" },
    { id: "categories-btn", count: adminData.totalCategories, label: "Categories Available", icon: <FaTags className="text-indigo-500 text-4xl" />, link: "/admin/categories" },
    { id: "products-btn", count: adminData.totalProducts, label: "Products Listed", icon: <FaBoxOpen className="text-orange-500 text-4xl" />, link: "/admin/products" },
    { id: "bookings-btn", count: adminData.totalBookings, label: "Bookings Received", icon: <FaClipboardList className="text-pink-500 text-4xl" />, link: "/admin/bookings" },
    { id: "feedbacks-btn", count: adminData.totalFeedbacks, label: "Feedbacks Received", icon: <FaComments className="text-yellow-500 text-4xl" />, link: "/admin/feedbacks" },
  ];
